<#
.SYNOPSIS
    Get WVD 2020 Spring Release Application Group information, sorted by HostPoolName and ApplicationGroupName.
.DESCRIPTION
    Get WVD 2020 Spring Release Application Group information, using the new Az.Desktopvirtualization PowerShell Module and WVD ARM Architecture (2020 Spring Release).
.EXAMPLE
    Get-WVDHostPoolApplicationGroup -SessionHostName <SessionHostName>
.CONTEXT
